...
function Application() {
    ...
    */
    ...
    var _BGCOLOR = "#ffffff";
    var _FONT = "Arial";
    var _TITLE = "Designer: Mary and Friends";
    ...
    */
    function _preloaderFunc() {
        ...
        */
        ...
        loadQueue.loadFile({
            id: "tick_sound",
            src: "library/sounds/tick_sound.ogg"
        });
        loadQueue.loadFile({
            id: "photo_sound",
    ...
    */
    let xAdsCounter = 2; // Initialize the counter variable

    function _onClickPlayBtnFunc(event) {
        xAdsCounter++; // Increment the counter

        if (xAdsCounter % 4 == 0) { 
            // Check if the counter is divisible by 3
            console.log('reload ad');
    ...
    function _constructorFunc() {
        ...
        */
        if (currentScreen_mc.moreGames_btn) {
            ...
            createjs.Tween.get(currentScreen_mc.moreGames_btn).wait(_DELAY * 1.0 * 1000).to({
                alpha: 1
            }, _DELAY * 1000, createjs.Ease.cubicInOut);
            currentScreen_mc.moreGames_btn.addEventListener("click", _onClickMoreGamesBtnFunc, false);
        }
        ...
        */
        if (currentScreen_mc.reset_btn) {
            ...
            createjs.Tween.get(currentScreen_mc.reset_btn).wait(_DELAY * 2.0 * 1000).to({
                alpha: 1
            }, _DELAY * 1000, createjs.Ease.cubicInOut);
        ...
        */
        if (currentScreen_mc.random_btn) {
            ...
            createjs.Tween.get(currentScreen_mc.random_btn).wait(_DELAY * 2.5 * 1000).to({
                alpha: 1
            }, _DELAY * 1000, createjs.Ease.cubicInOut);
...
let xNum = 0;
                    ...
                    */
                    ...
                    if (_information.heroes[_information.currentHero].dress.hasOwnProperty(target_str)) {
                        if (!dress_obj.hasOwnProperty(target_str)) {
                            dress_obj[target_str] = {
                                currentColor: _information.heroes[_information.currentHero].dress[target_str].currentColor
                            };
                        }
                    }
                    /*
    ...
    function _unblockDoneBtnConstructorFunc() {
        ...
        */
        if (!currentScreen_mc.done_btn.visible) {
            ...
            currentScreen_mc.done_btn.alpha = 0.01;
            createjs.Tween.get(currentScreen_mc.done_btn).wait(0).to({
                alpha: 1
            }, _DELAY * 1000, createjs.Ease.cubicInOut);
        }
    }
    ...
    */
    function _onClickPhotoBtnFunc(event) {
        ...
        window.location.href = "html5player://takeScreen";
        /*
    ...
    */
    ...
    function _onClickBannerMcFunc_1(event) {
       //  window.open("https://play.google.com/store/apps/details?id=com.ladybugmira.dressup");
    }

    function _onClickBannerMcFunc_2(event) {
       // window.open("https://play.google.com/store/apps/details?id=com.pony.dressup.rainbowdash");
    }
